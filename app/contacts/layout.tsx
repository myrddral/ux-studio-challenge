...
export default function ContactsLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className='grid grid-cols-[0fr_minmax(0,1fr)_0fr] grid-rows-[48px_96px_1fr] md:grid-rows-[repeat(2,96px)_1fr] items-center md:grid-cols-[1fr_768px_1fr]'>
      <div className='grid-child max-sm:hidden col-start-1 col-end-2 row-start-2 row-end-3 flex h-full items-center justify-end p-6 pr-4'>
        <Link href='/'>
      ...
      <div className='grid-child max-sm:hidden col-start-3 col-end-4 row-start-2 row-end-3 flex h-full items-center p-6 pl-4'>
        <LightModeSwitch />
      </div>
    </div>
  )
